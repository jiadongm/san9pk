...
- `nameTraditional` is intentionally `null` and `searchAliases` currently contains the verified simplified name only. Do not claim full traditional-character or pinyin search until names are reliably matched.
