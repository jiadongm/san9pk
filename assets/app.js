...
function renderAffinityRing() {
  ...
  $("affinity-ring").innerHTML = `<svg viewBox="0 0 400 400" role="group" aria-label="0 至 149 的相性圆环"><circle class="affinity-guide" cx="200" cy="200" r="151" />${arcs}<circle class="affinity-ring-hit-target" cx="200" cy="200" r="151" />${points}${labels}${regionLabels}<text class="affinity-center" x="200" y="190">相性位置</text><text class="affinity-value" x="200" y="220">${selected}</text></svg>`;
